...
const Footer = () => {
    return (
        <div className="container mx-auto my-20">
            ...
            <footer className="footer lg:px-10 py-4 border-t bg-base-200 text-base-content border-base-300 ">
                <div className="items-center mx-auto lg:mx-0">
                   <h1 className="text-2xl lg:text-3xl font-bold">Haven Vista</h1>
                    <p>HAVEN Real-Estate Ltd. <br />Providing reliable property since 1992</p>
                </div>
                <nav className="md:place-self-center md:justify-self-end mx-auto lg:mx-0">
