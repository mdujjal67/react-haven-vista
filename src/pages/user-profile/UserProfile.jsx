            ...
            <div className="w-24 lg:w-32 lg:h-32 h-24 rounded-full mx-auto mt-10 bg-gray-200">
                ...
                <div className="space-y-4 text-center divide-y dark:divide-gray-300">
                    ...
                    <div className="flex justify-center pt-2 space-x-4 align-center mt-5">
                        <a rel="noopener noreferrer" href="https://github.com/" aria-label="GitHub" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
                            <svg viewBox="0 0 496 512" xmlns={user?.photoURL} className="w-4 h-4 fill-current">
                        ...
                        <a rel="noopener noreferrer" href="https://dribbble.com/" aria-label="Dribble" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
                        ...
                        <a rel="noopener noreferrer" href="https://twitter.com/?lang=en" aria-label="Twitter" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
                            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
                        ...
                        <a rel="noopener noreferrer" href="https://mail.google.com" aria-label="Email" className="p-2 rounded-md dark:text-gray-800 hover:dark:text-violet-600">
                            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
