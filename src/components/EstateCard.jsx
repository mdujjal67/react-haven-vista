    ...
    return (
        <div>
            ...
            <Link to={`/home/${id}`}>
                ...
                <div className="">
                    <div className="card-wrapper p-6 border border-[#13131326] rounded-[16px] ease-in-out duration-300	lg:hover:blur-[0.5px] lg:hover:opacity-70 lg:hover:scale-105 mt-10 lg:mt-0">
                        <div className="bg-[#F3F3F3] rounded-[16px] mx-auto">
                            <img className="p-6 rounded-2xl" src={image} alt="Image" />
                        </div>
